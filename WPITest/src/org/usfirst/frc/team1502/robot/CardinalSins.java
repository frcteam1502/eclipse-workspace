...
public class CardinalSins {
	void assumption() {
		// Assuming everyone around you has the same understanding of your functions, yet they are clueless and need help explaining what they actually fucking do.
		// COMMENT!!!!
	}
